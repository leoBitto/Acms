    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Acms.image')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flex_grow', models.IntegerField(blank=True, default=1, help_text='\n        \n        ', null=True)),
                ('name', models.CharField(blank=True, max_length=10)),
                ('level', models.IntegerField(blank=True, default=5000, null=True)),
                ('button', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Acms.button')),
                ('containers', models.ManyToManyField(blank=True, to='Acms.Container')),
                ('link', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Acms.link')),
                ('sections', models.ManyToManyField(blank=True, to='Acms.Section')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='link',
            name='textShown',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Acms.text'),
        ),
        migrations.AddField(
            model_name='link',
            name='toPage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flex_grow', models.IntegerField(blank=True, default=1, help_text='\n        \n        ', null=True)),
                ('name', models.CharField(blank=True, max_length=100, null=True)),
                ('gap', models.CharField(max_length=10, null=True)),
                ('cell_min', models.CharField(max_length=10, null=True)),
